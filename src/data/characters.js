export const characters = {
	...
	마리드: {
		...
		info: {
			...
			commentArray: ['너무 감정적이야.', '진심이 느껴져서 좋다.', '공감을 잘 해주는 사람이야.'],
			well: ['디지니', '티이라'],
			bad: ['모스', '에띠'],
			originalExplanation:
	...
	티이라: {
		...
		info: {
			summary: '조용하고 신비로운 분위기를 지닌 내향형. 말은 적지만 깊은 감정을 지닌 타입입니다.',
			meritArray: [
				'공감과 배려의 깊이',
				'침착하고 감정에 휘둘리지 않음',
				'비밀을 잘 지키고 신중함'
